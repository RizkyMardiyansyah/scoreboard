...
const SubtitutionPage = () => {
  const subPhoto = localStorage.getItem("subPhotoUrlAway");
  const subPhoto2 = localStorage.getItem("subPhotoUrl2Away");
  const subName = localStorage.getItem("subPhotoNameAway");
  const subName2 = localStorage.getItem("subPhotoName2Away");
